# EPUB Check (Web Version)

## Overview

This web-based validator, built around the open source tool [epubcheck](http://code.google.com/p/epubcheck/), validates EPUB files, version 2.0 and later.
